...
namespace mir_msgs
{
  ...
  class RobotStatus : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 4) = (u_moved.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_moved.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_moved.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_moved.base >> (8 * 7)) & 0xFF;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_moved.base = 0;
      u_moved.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_moved.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_moved.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_moved.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_moved.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_moved.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_moved.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_moved.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
    ...
    const char * getType(){ return "mir_msgs/RobotStatus"; };
    const char * getMD5(){ return "18d07d8b4603caa865c6e7d49636c2d6"; };
